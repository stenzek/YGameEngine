            ...
            out float4 out_target : SV_Target)
{
	...
	float3 sceneColor = MaterialGetBaseColor(MPIParameters);
    out_target = ApplyGammaCorrection(MaterialCalcOutputColor(MPIParameters, sceneColor));
}
