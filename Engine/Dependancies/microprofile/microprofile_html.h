...
"}\n"
"\n"
"function MakeCounter(id, parent, sibling, firstchild, level, name, value, formatted, limit, formattedlimit, counterprc, boxprc)\n"
"{\n"
"	var counter = { \"id\":id, \"parent\":parent, \"sibling\":sibling, \"firstchild\":firstchild, \"level\": level, \"name\":name, \"value\":value, \"formatted\":formatted, \"limit\":limit, \"formattedlimit\":formattedlimit, \"counterprc\":counterprc, \"boxprc\":boxprc};\n"
"	return counter;\n"
"}\n"
"\n"
"\n"
...
"		nColorIndex = 1-nColorIndex;\n"
"		bMouseIn = DetailedViewMouseY >= Y && DetailedViewMouseY < Y + BoxHeight;\n"
"		if(bMouseIn && Counter.firstchild != -1)\n"
"		{\n"
"			nHoverCounter = Index;\n"
"		}\n"
...
"		context.textAlign = \'left\';\n"
"		X += FontWidth * 4;\n"
"		if(Counter.formattedlimit.length)\n"
"		{\n"
