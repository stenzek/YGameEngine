...
const char *D3D12TypeConversion::D3DFeatureLevelToString(D3D_FEATURE_LEVEL FeatureLevel)
{
...
D3D11_MAP D3D12TypeConversion::MapTypetoD3D11MapType(GPU_MAP_TYPE MapType)
{
...
const char *D3D12TypeConversion::VertexElementSemanticToString(GPU_VERTEX_ELEMENT_SEMANTIC semantic)
{
...
const char *D3D12TypeConversion::VertexElementTypeToShaderTypeString(GPU_VERTEX_ELEMENT_TYPE type)
{
...
DXGI_FORMAT D3D12TypeConversion::VertexElementTypeToDXGIFormat(GPU_VERTEX_ELEMENT_TYPE type)
{
    // lookup table for types
...
bool D3D12Helpers::CreateD3D11RasterizerState(const RENDERER_RASTERIZER_STATE_DESC *pRasterizerState, D3D12_RASTERIZER_DESC *pOutRasterizerDesc)
{
...
bool D3D12Helpers::CreateD3D11DepthStencilState(const RENDERER_DEPTHSTENCIL_STATE_DESC *pDepthStencilState, D3D12_DEPTH_STENCIL_DESC *pOutDepthStencilDesc)
{
...
bool D3D12Helpers::CreateD3D11BlendState(const RENDERER_BLEND_STATE_DESC *pBlendState, D3D12_BLEND_DESC *pOutBlendDesc)
{
...
bool D3D12Helpers::CreateD3D11SamplerState(const GPU_SAMPLER_STATE_DESC *pSamplerStateDesc, D3D12_SAMPLER_DESC *pOutSamplerStateDesc)
{
...
void D3D12Helpers::CorrectProjectionMatrix(float4x4 &projectionMatrix)
{
