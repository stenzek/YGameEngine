...
BEGIN_SHADER_CONSTANT_BUFFER(cbDeferredDirectionalLightParameters, "DeferredDirectionalLightParameters", "cbDeferredDirectionalLightParameters", RENDERER_PLATFORM_COUNT, RENDERER_FEATURE_LEVEL_SM4)
...
BEGIN_SHADER_CONSTANT_BUFFER(cbDeferredPointLightParameters, "DeferredPointLightParameters", "cbDeferredPointLightParameters", RENDERER_PLATFORM_COUNT, RENDERER_FEATURE_LEVEL_COUNT)
    SHADER_CONSTANT_BUFFER_FIELD("LightColor", SHADER_PARAMETER_TYPE_FLOAT3, 1)
...
DEFINE_RAW_SHADER_CONSTANT_BUFFER(cbDeferredTiledPointLightShaderLightBuffer, "DeferredTiledPointLightShaderLightBuffer", "", sizeof(DeferredTiledPointLightShader::Light) * DeferredTiledPointLightShader::MAX_LIGHTS_PER_DISPATCH, RENDERER_PLATFORM_COUNT, RENDERER_FEATURE_LEVEL_SM5)
