...
BEGIN_SHADER_CONSTANT_BUFFER(cbDirectionalLightParameters, "DirectionalLightParameters", "cbDirectionalLightParameters", RENDERER_PLATFORM_COUNT, RENDERER_FEATURE_LEVEL_COUNT)
...
BEGIN_SHADER_CONSTANT_BUFFER(cbPointLightParameters, "PointLightParameters", "cbPointLightParameters", RENDERER_PLATFORM_COUNT, RENDERER_FEATURE_LEVEL_COUNT)
    SHADER_CONSTANT_BUFFER_FIELD("LightColor", SHADER_PARAMETER_TYPE_FLOAT3, 1)
...
BEGIN_SHADER_CONSTANT_BUFFER(cbPointLightListParameters, "PointLightListParameters", "cbPointLightListParameters", RENDERER_PLATFORM_COUNT, RENDERER_FEATURE_LEVEL_COUNT)
...
BEGIN_SHADER_CONSTANT_BUFFER(cbVolumetricLightShader, "VolumetricLightShader", "cbVolumetricLightParameters", RENDERER_PLATFORM_COUNT, RENDERER_FEATURE_LEVEL_COUNT)
    SHADER_CONSTANT_BUFFER_FIELD("LightColor", SHADER_PARAMETER_TYPE_FLOAT3, 1)
    SHADER_CONSTANT_BUFFER_FIELD("LightPosition", SHADER_PARAMETER_TYPE_FLOAT3, 1)
