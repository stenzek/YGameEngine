...
BEGIN_SHADER_CONSTANT_BUFFER(cbMobileDirectionalLightParameters, "MobileDirectionalLightParametersBuffer", "MobileDirectionalLightParameters", RENDERER_PLATFORM_COUNT, RENDERER_FEATURE_LEVEL_COUNT)
