...
void OneColorShader::SetColor(GPUCommandList *pCommandList, ShaderProgram *pShaderProgram, const float4 &col)
{
    pShaderProgram->SetBaseShaderParameterValue(pCommandList, 0, SHADER_PARAMETER_TYPE_FLOAT4, &col);
}
